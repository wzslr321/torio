...
description: Task-oriented Torio guides — open the operator SSH tunnel, pin a session token, point Hermes Desktop at the backend and a project, configure a provider, attach and inspect repositories, push what you decide to push, edit with your own editor, and diagnose why a command is not running.
...
<!-- include: project-attach -->

<!-- include: project-push -->
