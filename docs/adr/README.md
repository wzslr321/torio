...
| [0007](0007-publication-by-rewritten-history.md) | Publication is a rewritten history pushed to a new repository, because the old one keeps serving its pull-request references |
...
`docs/adr/`. They no longer carry the delivery-evidence tree, which
[ADR-0007](0007-publication-by-rewritten-history.md) purges from every commit.
...
[ADR-0004](0004-mcp-credential-custody-and-egress.md) and
[ADR-0005](0005-repository-and-documentation-governance.md) carry one.
...
[ADR-0007](0007-publication-by-rewritten-history.md) does this for
[ADR-0005](0005-repository-and-documentation-governance.md) §6.
